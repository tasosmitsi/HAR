...
class DistributionBasedOutlierDetection:
    ...
    def mixture_model(self, data_table, col, comp, init):
        ...
        g = GaussianMixture(n_components=comp, max_iter=100, n_init=init)     # originally n_components=3, max_iter=100, n_init=1
